...
var _chunkPRMLCGIOcjs = require('./chunk-PRMLCGIO.cjs');
...
function normalizeImport(info, name) {
  ...
  return _chunkPRMLCGIOcjs.__spreadValues.call(void 0, {
    name,
    as: name
  }, info);
}
...
function flattenImports(map, overriding = false) {
  ...
  _utils.toArray.call(void 0, map).forEach((definition) => {
    if (typeof definition === "string") {
      if (!_chunkPRMLCGIOcjs.presets[definition])
        throw new Error(`[auto-import] preset ${definition} not found`);
      const preset = _chunkPRMLCGIOcjs.presets[definition];
